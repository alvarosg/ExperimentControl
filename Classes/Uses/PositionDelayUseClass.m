...
classdef PositionDelayUseClass<AbstractUseClass
    ...
    methods
        function o = PositionDelayUseClass(stageInfo,stageController,stagesHand)
        ...
        function stagePosition=varPos2stagePos(o,varPosition)
            ...
            stagePosition=str2num(o.stageInfo.extraparam)+varPosition*(PositionDelayUseClass.c/1000)/2;
        end
        
        function varPosition=stagePos2varPos(o,stagePosition)
            %Convert time in fs to position in nm
            varPosition=(stagePosition-str2num(o.stageInfo.extraparam))/(PositionDelayUseClass.c/1000)*2;
        end
        function set0(o)
            o.setPosition(0);
        end
