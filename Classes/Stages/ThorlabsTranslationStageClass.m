...
classdef ThorlabsTranslationStageClass<AbstractStageClass
    ...
    methods
        function o = ThorlabsTranslationStageClass(stageInfo) 
        ...
        function outPosition=gotoPosition(o,position)
            o.data.activex1.SetAbsMovePos(0, position/1e3);
            drawnow
            o.data.activex1.MoveAbsolute(0, true);
            outPosition=o.data.activex1.GetPosition_Position(0)*1e3;
        end
        ...
        function minPos=minPosition(o)
            minPos=o.data.activex1.GetStageAxisInfo_MinPos(0)*1e3;            
        end
        function maxPos=maxPosition(o)
            maxPos=o.data.activex1.GetStageAxisInfo_MaxPos(0)*1e3;  
        end
