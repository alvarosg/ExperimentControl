...
classdef StageDiscretePositionsControlPanel<handle
    ...
    methods
        function o=StageDiscretePositionsControlPanel(parentC,stageController,useController)            
            o.parentC=parentC;
            ...
            o.useControllerPanel=DiscretePositionsUsePanel(hgh,useController);
