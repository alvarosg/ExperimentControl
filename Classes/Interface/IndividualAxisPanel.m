...
classdef IndividualAxisPanel<handle
    ...
    methods
        function o=IndividualAxisPanel(parentC,controller,name)
            ...
            hghv1 = uigridcontainer('v0','Parent',hgh,'Units','norm','Position',[0,0,1,1],'GridSize',[5,1], 'VerticalWeight',[1 1 1 1 1],'Margin',1);
            
            uicontrol('Parent',hghv1,'style','text','string',sprintf('%s',o.name));
            
            hghv1h1 = uigridcontainer('v0','Parent',hghv1,'Units','norm','Position',[0,0,1,1],'GridSize',[1,2], 'HorizontalWeight',[1 1],'Margin',1);
            hghv1h2 = uigridcontainer('v0','Parent',hghv1,'Units','norm','Position',[0,0,1,1],'GridSize',[1,2], 'HorizontalWeight',[1 1],'Margin',1);
            hghv1h3 = uigridcontainer('v0','Parent',hghv1,'Units','norm','Position',[0,0,1,1],'GridSize',[1,2], 'HorizontalWeight',[1 1],'Margin',1);
            hghv1h4 = uigridcontainer('v0','Parent',hghv1,'Units','norm','Position',[0,0,1,1],'GridSize',[1,4], 'HorizontalWeight',[1.1 0.6 0.2 0.2],'Margin',1);
