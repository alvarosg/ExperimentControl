...
classdef LivePlotting<handle
    ...
    methods
        function o=LivePlotting(parentC,scanVariableList,label,initialTime,dataTaker,deviceController)
            ...
            MessageSystem.get().AddSecondOutput(textStatus);
        ...
        function setCombosPoints(o)                        
            ...
            xlim(o.plotAxis,[o.scanVariableList{currentVariable}.positions(1),o.scanVariableList{currentVariable}.positions(end)])  
        end
        ...
        function printScreen(o,path)
            try
                %print(o.parentC,path,'-dpng')
                img = getframe(o.parentC);
                imwrite(img.cdata, path);
            catch
            end
        end
