...
classdef RemoteDevicePanel<handle
    ...
    methods
        function o=RemoteDevicePanel(parentC,controller,acquisitionDevicesHand)
            o.parentC=parentC;
            ...
            o.pushReconnect=uicontrol('Parent',hgh,'style','push','string','Reconnect');
            set(o.pushReconnect,'Callback',@(s,e)pushedReconnect(o,s,e))
        ...
        function pushedReconnect(o,s,e)
            o.controller.reconnect();
            update(o,true);
        end
